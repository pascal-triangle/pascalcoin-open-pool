...
// TODO make sure var diff is not higher than block diff
...
var varDiffManager = module.exports = function varDiffManager(port, varDiffOptions) {
    var _this = this;
...
varDiffManager.prototype.__proto__ = EventEmitter.prototype;
